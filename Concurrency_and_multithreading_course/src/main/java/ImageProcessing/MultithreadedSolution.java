...
public class MultithreadedSolution {
    public static final String SOURCE_FILE = "Concurrency_and_multithreading_course/src/main/resources/many-flowers.jpg";
    public static final String DESTINATION_FILE = "./out/many-flowers-mt.jpg";
    public static void main(String... args) throws IOException {
        BufferedImage originalImage = ImageIO.read(new File(SOURCE_FILE));
        BufferedImage resultImage = new BufferedImage(originalImage.getWidth(), originalImage.getHeight(), BufferedImage.TYPE_INT_RGB);
        long startTime = System.currentTimeMillis();
        recolorMultiThread(originalImage, resultImage, 8);
